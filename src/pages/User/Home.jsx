          ...
          <div className="col-lg-12">
            <div className="testimonial-slider-wrap text-center">
              <div id="testimonial-nav">
                <span className="prev" onClick={prevSlide} data-controls="prev">
                  <span className="fa fa-chevron-left"></span>
                </span>
                <span className="next" onClick={nextSlide} data-controls="next">
                      ...
                      <div className="testimonial-block text-center">
                        ...
                        <div className="author-info">
                          <div className="author-pic">
                            <img src={testimonials[currentSlide].image} alt={testimonials[currentSlide].name} className="img-fluid" />
                          </div>
                          <h3 className="font-weight-bold">{testimonials[currentSlide].name}</h3>
                          <span className="position d-block mb-3">{testimonials[currentSlide].position}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                {/* You can repeat this structure for other slides if needed */}
